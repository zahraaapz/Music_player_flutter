          ...
          child: AnimatedBuilder(
           ...
           Stack(
              children: [
                  AnimatedPositioned(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient:LinearGradient(colors: [Color.fromARGB(19, 33, 149, 243),const Color.fromARGB(0, 64, 195, 255)]) ,
                ...
                Positioned(
                  top:Get.height/2,right: Get.width/2,
                  child: Transform.rotate(
                          
                    angle: x.value,
                    child:SvgPicture.asset('assets/2.svg',color:Colors.indigo,width: 120,height: 120,)
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient:LinearGradient(
                          ...
                          colors: [ const Color.fromARGB(19, 63, 81, 181),Color.fromARGB(0, 63, 81, 181)]) ,
                        shape: BoxShape.circle,
